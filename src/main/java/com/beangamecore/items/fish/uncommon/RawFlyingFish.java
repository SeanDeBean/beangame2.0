...
public class RawFlyingFish extends BeangameFish implements BGSmeltableI, BeangameSoftItem {

    @Override
    public void onSmelt(FurnaceSmeltEvent event) {
        event.setResult(BeangameItemRegistry.getRaw(NamespacedKey.fromString("beangame:cookedflyingfish")).asItem());
    }

    public RawFlyingFish() {
        setIsFishable(true);
        setWeight(90);
        setMinWaterDepth(0);
        setMinPlayerLevel(0);
    ...
    @Override
    public String getId() {
        return "rawflyingfish";
    }

    @Override
    public String getName() {
        return "§fRaw Flying Fish";
    }
