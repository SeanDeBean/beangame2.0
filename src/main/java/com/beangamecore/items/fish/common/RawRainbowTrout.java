...
public class RawRainbowTrout extends BeangameFish implements BGSmeltableI, BeangameSoftItem {

    @Override
    public void onSmelt(FurnaceSmeltEvent event) {
        event.setResult(BeangameItemRegistry.getRaw(NamespacedKey.fromString("beangame:cookedrainbowtrout")).asItem());
    }

    public RawRainbowTrout() {
        setIsFishable(true);
        setWeight(140);
        setMinWaterDepth(0);
        setMinPlayerLevel(0);
    ...
    @Override
    public String getId() {
        return "rawrainbowtrout";
    }

    @Override
    public String getName() {
        return "§fRaw Rainbow Trout";
    }
