...
public class BasedPridefish extends BeangameFish implements BGSmeltableI, BeangameSoftItem {

    @Override
    public void onSmelt(FurnaceSmeltEvent event) {
        event.setResult(BeangameItemRegistry.getRaw(NamespacedKey.fromString("beangame:cookedpridefish")).asItem());
    }

    public BasedPridefish() {
        setIsFishable(true);
        setWeight(10);
        setMinWaterDepth(0);
        setMinPlayerLevel(0);
    ...
    @Override
    public String getId() {
        return "basedpridefish";
    }

    @Override
    public String getName() {
        return "§fBased Pridefish";
    }
