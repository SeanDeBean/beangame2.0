...
public class CookedSirBubbles extends BeangameFish implements BeangameSoftItem {

    public CookedSirBubbles() {
        setIsFishable(false);
    }

    @Override
    public String getId() {
        return "cookedsirbubbles";
    }

    @Override
    public String getName() {
        return "§fCooked Sir Bubbles";
    }
