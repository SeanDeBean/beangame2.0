...
public class BirchHelmet extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.birchhelmet");
        meta.addAttributeModifier(Attribute.MOVEMENT_SPEED, new AttributeModifier(nsk, 0.007, AttributeModifier.Operation.ADD_SCALAR, EquipmentSlotGroup.HEAD));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "   ", r.mCFromMaterial(Material.BIRCH_LOG));
    }

    @Override
    public String getName() {
        return "§fBirch Helmet";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Head:", "§9+" + getArmor() + " Armor", "§9+0.007 Speed");
    }
