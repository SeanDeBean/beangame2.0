...
public class BirchChestplate extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.birchchestplate");
        meta.addAttributeModifier(Attribute.MOVEMENT_SPEED, new AttributeModifier(nsk, 0.009, AttributeModifier.Operation.ADD_SCALAR, EquipmentSlotGroup.CHEST));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "W W", "WWW", "WWW", r.mCFromMaterial(Material.BIRCH_LOG));
    }

    @Override
    public String getName() {
        return "§fBirch Chestplate";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Body:", "§9+" + getArmor() + " Armor", "§9+0.009 Speed");
    }
