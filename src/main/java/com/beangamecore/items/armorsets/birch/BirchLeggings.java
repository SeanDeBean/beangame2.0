...
public class BirchLeggings extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.birchleggings");
        meta.addAttributeModifier(Attribute.MOVEMENT_SPEED, new AttributeModifier(nsk, 0.009, AttributeModifier.Operation.ADD_SCALAR, EquipmentSlotGroup.LEGS));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "W W", r.mCFromMaterial(Material.BIRCH_LOG));
    }

    @Override
    public String getName() {
        return "§fBirch Leggings";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Legs:", "§9+" + getArmor() + " Armor", "§9+0.009 Speed");
    }
