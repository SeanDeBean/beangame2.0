...
public class AcaciaHelmet extends BeangameItem implements BeangameSoftItem {
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "   ", r.mCFromMaterial(Material.ACACIA_LOG));
    }

    @Override
    public String getName() {
        return "§fAcacia Helmet";
    }
