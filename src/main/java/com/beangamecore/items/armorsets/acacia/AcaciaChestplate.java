...
public class AcaciaChestplate extends BeangameItem implements BeangameSoftItem {
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "W W", "WWW", "WWW", r.mCFromMaterial(Material.ACACIA_LOG));
    }

    @Override
    public String getName() {
        return "§fAcacia Chestplate";
    }
