...
public class AcaciaBoots extends BeangameItem implements BeangameSoftItem {
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "W W", "W W", "   ", r.mCFromMaterial(Material.ACACIA_LOG));
    }

    @Override
    public String getName() {
        return "§fAcacia Boots";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Feet:", "§9+" + getArmor() + " Armor");
    }
