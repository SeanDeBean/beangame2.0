...
public class PaleOakLeggings extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.paleoakleggings");
        meta.addAttributeModifier(Attribute.ARMOR_TOUGHNESS, new AttributeModifier(nsk, 2, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "W W", r.mCFromMaterial(Material.PALE_OAK_LOG));
    }

    @Override
    public String getName() {
        return "§fPale Oak Leggings";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Legs:", "§9+" + getArmor() + " Armor", "§9+2 Armor Toughness");
    }
