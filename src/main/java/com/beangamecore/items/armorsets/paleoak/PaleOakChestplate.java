...
public class PaleOakChestplate extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.paleoakchestplate");
        meta.addAttributeModifier(Attribute.ARMOR_TOUGHNESS, new AttributeModifier(nsk, 2, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.CHEST));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "W W", "WWW", "WWW", r.mCFromMaterial(Material.PALE_OAK_LOG));
    }

    @Override
    public String getName() {
        return "§fPale Oak Chestplate";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Body:", "§9+" + getArmor() + " Armor", "§9+2 Armor Toughness");
    }
