...
public class PaleOakBoots extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.paleoakboots");
        meta.addAttributeModifier(Attribute.ARMOR_TOUGHNESS, new AttributeModifier(nsk, 2, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "W W", "W W", "   ", r.mCFromMaterial(Material.PALE_OAK_LOG));
    }

    @Override
    public String getName() {
        return "§fPale Oak Boots";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Feet:", "§9+" + getArmor() + " Armor", "§9+2 Armor Toughness");
    }
