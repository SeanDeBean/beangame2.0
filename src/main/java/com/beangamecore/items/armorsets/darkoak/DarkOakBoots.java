...
public class DarkOakBoots extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.darkoakboots");
        meta.addAttributeModifier(Attribute.MAX_HEALTH, new AttributeModifier(nsk, 1, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "W W", "W W", "   ", r.mCFromMaterial(Material.DARK_OAK_LOG));
    }

    @Override
    public String getName() {
        return "§fDark Oak Boots";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Feet:", "§9+" + getArmor() + " Armor", "§9+1 Max Health");
    }
