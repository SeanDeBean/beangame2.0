...
public class DarkOakLeggings extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.darkoakleggings");
        meta.addAttributeModifier(Attribute.MAX_HEALTH, new AttributeModifier(nsk, 2, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "W W", r.mCFromMaterial(Material.DARK_OAK_LOG));
    }

    @Override
    public String getName() {
        return "§fDark Oak Leggings";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Legs:", "§9+" + getArmor() + " Armor", "§9+2 Max Health");
    }
