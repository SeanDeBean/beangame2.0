...
public class OakLeggings extends BeangameItem implements BeangameSoftItem {
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "W W", r.mCFromMaterial(Material.OAK_LOG));
    }

    @Override
    public String getName() {
        return "§fOak Leggings";
    }
