...
public class SpruceLeggings extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.spruceleggings");
        meta.addAttributeModifier(Attribute.SCALE, new AttributeModifier(nsk, 0.09, AttributeModifier.Operation.ADD_SCALAR, EquipmentSlotGroup.LEGS));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "W W", r.mCFromMaterial(Material.SPRUCE_LOG));
    }

    @Override
    public String getName() {
        return "§fSpruce Leggings";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Legs:", "§9+" + getArmor() + " Armor", "§9+0.09 Scale");
    }
