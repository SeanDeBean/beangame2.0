...
public class CherryBoots extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.cherryboots");
        meta.addAttributeModifier(Attribute.STEP_HEIGHT, new AttributeModifier(nsk, 0.5, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.FEET));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "W W", "W W", "   ", r.mCFromMaterial(Material.CHERRY_LOG));
    }

    @Override
    public String getName() {
        return "§fCherry Boots";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Feet:", "§9+" + getArmor() + " Armor", "§9+0.5 Step Height");
    }
