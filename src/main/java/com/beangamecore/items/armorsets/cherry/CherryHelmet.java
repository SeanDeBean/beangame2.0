...
public class CherryHelmet extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.cherryhelmet");
        meta.addAttributeModifier(Attribute.STEP_HEIGHT, new AttributeModifier(nsk, 0.5, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.HEAD));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "   ", r.mCFromMaterial(Material.CHERRY_LOG));
    }

    @Override
    public String getName() {
        return "§fCherry Helmet";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Head:", "§9+" + getArmor() + " Armor", "§9+0.5 Step Height");
    }
