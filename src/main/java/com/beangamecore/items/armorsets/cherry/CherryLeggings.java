...
public class CherryLeggings extends BeangameItem implements BeangameSoftItem {
    ...
    public ItemStack asItem(){
        ...
        NamespacedKey nsk = new NamespacedKey(Main.getPlugin(), "beangame.cherryleggings");
        meta.addAttributeModifier(Attribute.STEP_HEIGHT, new AttributeModifier(nsk, 0.5, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.LEGS));
    ...
    public CraftingRecipe getCraftingRecipe() {
        ...
        return r.bgShapedRecipe(this, "WWW", "W W", "W W", r.mCFromMaterial(Material.CHERRY_LOG));
    }

    @Override
    public String getName() {
        return "§fCherry Leggings";
    }

    @Override
    public List<String> getLore() {
        return List.of("§9§obeangame", "§9", "§7When on Legs:", "§9+" + getArmor() + " Armor", "§9+0.5 Step Height");
    }
